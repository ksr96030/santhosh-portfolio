...
const HtmlIcon = () => (
  <svg width="44" height="44" viewBox="0 0 48 48" fill="none" aria-hidden="true">
    <path d="M8 4h32l-3 36-13 4-13-4L8 4z" fill="#E44D26"/>
    <path d="M24 41l10-3 2-26H24v29z" fill="#F16529"/>
...
const CssIcon = () => (
  <svg width="44" height="44" viewBox="0 0 48 48" fill="none" aria-hidden="true">
    <path d="M8 4h32l-3 36-13 4-13-4L8 4z" fill="#1572B6"/>
    <path d="M24 41l10-3 2-26H24v29z" fill="#33A9DC"/>
    <path d="M24 16h11l-.3 3H24v-3zm0 8h10.4l-.5 3.9L24 30v-6z" fill="#fff"/>
...
const MicrosoftIcon = () => (
  <svg width="46" height="46" viewBox="0 0 44 44" aria-hidden="true">
    <rect width="20" height="20" x="2" y="2" fill="#F25022"/>
    <rect width="20" height="20" x="22" y="2" fill="#7FBA00"/>
    <rect width="20" height="20" x="2" y="22" fill="#00A4EF"/>
    <rect width="20" height="20" x="22" y="22" fill="#FFB900"/>
  </svg>
);
...
const IconTile = ({ children, title }) => (
  <div className="w-28 h-28">
    <div className="relative w-full h-full bg-gray-800/60 border border-gray-700 rounded-xl flex items-center justify-center overflow-hidden group hover:border-indigo-500 transition-all duration-300">
      ...
      <div className="transform group-hover:scale-110 transition-transform duration-300">{children}</div>
    </div>
    <p className="mt-2 text-center text-sm text-gray-300">{title}</p>
  </div>
);
...
const App = () => {
  ...
  /* ------------------------------ DATA: SKILLS ------------------------------ */
  // All skills requested (icons + names below).
  const skills = [
  ...
  /* -------------------------- DATA: CERTIFICATIONS ------------------------- */
  // Includes the two AWS certs (your requirement) + issuer icons for others.
  ...
  const projects = [
    {
      ...
      description:
        "Full-stack web application with Spring Boot backend and React frontend. Features role-based JWT authentication, listing monetization system, and a fully responsive UI design.",
      tech: ["Spring Boot", "React", "MySQL", "JWT", "Tailwind CSS"],
    },
    {
      title: "AI-Powered Resume Tailoring Platform",
      href: "https://github.com/ksr96030/resume-tailor-ai-suite",
      description:
        "AI-driven ATS optimization platform built with Java Spring Boot, React, MySQL, and Hugging Face. Provides resume/job uploads, ATS scoring, and tailor APIs with real-time score visualization and tailored PDF export.",
      tech: ["Java Spring Boot", "React.js", "MySQL", "Hugging Face", "REST APIs"],
    },
  ];
    ...
    <div className="bg-gray-900 text-white min-h-screen relative overflow-x-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 border border-gray-700 hover:border-indigo-500 transition-all duration-500">
            <p className="text-lg leading-relaxed text-center text-gray-300">
              ...
              I work with Java/Spring Boot, React.js, Docker/Kubernetes, and AWS — with experience
              in HIPAA-compliant systems, cloud architecture, and Agile delivery.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section title="Technical Skills" className="bg-gray-800/30">
        <div className="flex flex-row flex-wrap justify-center gap-10">
          {skills.map(({ name, Icon }, idx) => (
            <IconTile key={name + idx} title={name}>
              <Icon />
            </IconTile>
          ))}
        </div>
      ...
      <Section title="Education">
        <div className="max-w-4xl mx-auto grid gap-6">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 border border-gray-700">
            <div className="flex items-center justify-between mb-1">
              <h3 className="text-xl font-semibold text-indigo-200">Bachelor’s in Electronics and Communication Engineering</h3>
      ...
      <Section title="Certifications" className="bg-gray-800/30">
        <div className="max-w-5xl mx-auto grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {certifications.map(({ title, issuer, date, Icon }) => (
            <div
              key={title}
              className="flex items-center gap-4 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-5 border border-gray-700 hover:border-indigo-500 transition-all duration-300"
            >
      ...
      <Section title="Featured Projects">
        <div className="max-w-6xl mx-auto grid gap-8 md:grid-cols-2 justify-items-center">
          {projects.map((p, idx) => (
            <ProjectCard
              key={p.title}
              href={p.href}
      ...
      <footer className="relative border-t border-gray-700 py-8">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <p className="text-gray-400">© {new Date().getFullYear()} Santhosh Reddy Komatireddy</p>
        </div>
      </footer>
    </div>
  );
